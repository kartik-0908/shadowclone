  ...
  return (
    <div style={styles.container}>
      <div style={styles.content}>
        ...
        >
          Why Choose Shadowclone AI for Your Enterprise?
        </motion.h2>
        <motion.ul style={styles.list} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.6 }}>
          ...
          <li style={styles.listItem}>
            <strong>Multi-Channel Engagement:</strong> Shadowclone AI consolidates voice and chat capabilities into one platform, delivering consistent, high-quality interactions across channels to meet your customers wherever they are.
          </li>
          <li style={styles.listItem}>
        ...
        <motion.p style={styles.paragraph} initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut", delay: 1.2 }}>
          Switching to Shadowclone AI is effortless. Our dedicated team works closely with you to integrate our platform into your existing workflows, ensuring a smooth transition with minimal disruption.
        </motion.p>
        ...
        <motion.ul style={styles.list} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 1.4 }}>
          ...
          <li style={styles.listItem}>- Proposal & Implementation Strategy: Custom-fit Shadowclone AI to your needs.</li>
          ...
          <li style={styles.listItem}>- Comprehensive Training: Onboard your team with Shadowclone AI’s capabilities.</li>
        ...
        <motion.p style={styles.paragraph} initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut", delay: 2 }}>
          Shadowclone AI is committed to upholding the highest standards in data security and compliance. Your customer data is protected with stringent security protocols, ensuring privacy and trust.
        </motion.p>
