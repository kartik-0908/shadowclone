    ...
    <nav className="navbar">
      <div className="navbar-logo">
        <Link to="/" className="logo-link">
          ...
          <span className="logo-text">Shadowclone AI</span> {/* Company name */}
        </Link>
      </div>
      ...
      <div className="navbar-actions">
        ...
        <button
          data-cal-namespace="30min" data-cal-link="Shadowclone-ai-demo/30min" data-cal-config='{"layout":"month_view"}'
