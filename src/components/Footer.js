    ...
    <div style={styles.footerContainer}>
      <div style={styles.footerContent}>
        ...
        <div style={styles.logoSection}>
          ...
          <span style={styles.logoText}>Shadowclone AI</span>
        </div>

        {/* Social Media Icons Section */}
        <div style={styles.socialIcons}>
          <a href="https://www.instagram.com/Shadowclone.ai?igsh=MXQxdjQyMW83ZWc3" target="_blank" rel="noopener noreferrer" style={styles.icon}>
            <FaInstagram />
          </a>
          <a href="https://x.com/Shadowclone_ai" target="_blank" rel="noopener noreferrer" style={styles.icon}>
            <FaTwitter />
          </a>
          <a href="https://www.linkedin.com/company/Shadowcloneai" target="_blank" rel="noopener noreferrer" style={styles.icon}>
            <FaLinkedin />
          </a>
        </div>
      ...
      <div style={styles.footerBottom}>
        ...
        <p style={styles.footerBottomText}>© 2024 Shadowclone AI. All rights reserved.</p>
