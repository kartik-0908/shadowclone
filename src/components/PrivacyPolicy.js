    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-100">
      <main className="container mx-auto px-4 py-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-white text-center">
          Privacy Policy for Shadowclone AI
        </h1>
          ...
          <section className="space-y-12">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Welcome to Shadowclone AI ("we", "our", or "us"), a product of Sparton Technologies. We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered customer support service.
              </p>
            </div>
            ...
            <div>
              ...
              <address className="text-gray-300 not-italic bg-gray-800/50 p-6 rounded-lg">
                <div className="space-y-2">
                  ...
                  <p>
                    Email:{" "}
                    <a href="mailto:sales@Shadowclone.tech" className="text-blue-400 hover:text-blue-300 transition-colors">
                      sales@Shadowclone.tech
                    </a>
                  </p>
                  <p>
                    Phone:{" "}
